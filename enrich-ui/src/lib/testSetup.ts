...
export const restHandlers = [
	...
	rest.post(OAR_SERVICE_BASE_URL + '/query/exception', () => {
	...
	rest.get(OAR_SERVICE_BASE_URL + '/tests/exception', () => {
